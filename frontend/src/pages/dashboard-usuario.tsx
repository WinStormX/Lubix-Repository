          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-900 rounded-xl border border-slate-800 p-6">
              ...
              <div className="space-y-4">
                {[
                  { label: 'Nombre completo', value: userData.name, icon: <UserIcon className="w-4 h-4 text-gray-400" /> },
                  { label: 'Correo electrónico', value: userData.email, icon: <EnvelopeIcon className="w-4 h-4 text-gray-400" /> },
                  { label: 'Teléfono', value: userData.phone, icon: <PhoneIcon className="w-4 h-4 text-gray-400" /> },
                  { label: 'Miembro desde', value: userData.memberSince, icon: <CalendarIcon className="w-4 h-4 text-gray-400" /> },
                ].map((field) => (
